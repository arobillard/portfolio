...
function infoCardsAnimations() {
  const infoCardsSections = document.querySelectorAll(".info-cards");

  infoCardsSections.forEach((section) => {
...
if (!prefersReducedMotion()) infoCardsAnimations();
