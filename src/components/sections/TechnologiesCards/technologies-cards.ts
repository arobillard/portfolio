...
function technologiesCardsAnimations() {
  const technologiesCardsSections = document.querySelectorAll(
    ".technologies-cards",
  );

  technologiesCardsSections.forEach((section) => {
...
if (!prefersReducedMotion()) technologiesCardsAnimations();
